	...
	<div class="right_col servi" role="main" style="min-height: 1113px!important;">
		...
		<div class="x_content">
			<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
				...
				<?php endif; ?>
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('report_view')): ?>
					<li class="active setMarginForReportOnSmallDeviceServiceByEmployee"><a href="<?php echo url('/report/servicebyemployee'); ?>" class="anchor_tag anchr"> <i class="fa fa-slack image_icon"> </i> <b> <?php echo e(trans('app.Emp. Services')); ?> </b> </a></li>
				<?php endif; ?>
			</ul>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_content">
						<form method="post" action="<?php echo url('/report/employeeservice'); ?>" enctype="multipart/form-data"  class="form-horizontal upperform">
							...
							<div class="col-md-4 col-sm-6 col-xs-12 form-group">
							   <label class="control-label col-md-5 col-sm-5 col-xs-12"  for="option"><?php echo e(trans('app.Select Employee')); ?> </label>
								</label>
								
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select class="form-control" name="s_customer">
										<option value="all"<?php if($all_employee=='all'){ echo 'selected'; } ?>><?php echo e(trans('app.All')); ?></option>
										<?php if(!empty($Select_employee)): ?>
										<?php $__currentLoopData = $Select_employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Select_employees): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										 <option value="<?php echo e($Select_employees->id); ?>" <?php if($Select_employees->id == $all_employee) { echo  'selected'; } ?>><?php echo e($Select_employees->name); ?></option>
				...
				<div class="x_panel table_up_div">
					<table id="datatable" class="table table-striped jambo_table" style="margin-top:20px;">
						<thead>
							<tr>
								<th>#</th>
								<th><?php echo e(trans('app.Jobcard Number')); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\garage\resources\views/report/service/empservicelist.blade.php ENDPATH**/ ?>