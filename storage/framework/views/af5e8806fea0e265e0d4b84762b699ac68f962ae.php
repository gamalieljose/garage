				...
				<div class="nav_menu">
					<nav>
						<div class="nav toggle">
							<a id="menu_toggle"><i class="fa fa-bars"></i><span class="titleup">&nbsp <?php echo e(trans('app.Vehicle Type')); ?></span></a>
						</div>
					...
					<div class="x_content">
						<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vehicletype_view')): ?>
								<li role="presentation" class="active"><a href="<?php echo url('/vehicletype/list'); ?>"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i><b><?php echo e(trans('app.VehicleType List')); ?></b></a></li>
							<?php endif; ?>
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vehicletype_add')): ?>
								<li role="presentation" class=""><a href="<?php echo url('/vehicletype/vehicletypeadd'); ?>"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i><?php echo e(trans('app.Add VehicleType')); ?></a></li>
							<?php endif; ?>
						</ul>
					</div>
					<div class="x_panel">
						<table id="datatable" class="table table-striped jambo_table" style="margin-top:20px;">
							<thead>
								<tr>
								   <th>#</th>
								  <th><?php echo e(trans('app.Vehicle Type')); ?></th>
								...
								<!-- Custom Field Data End -->
									...
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['vehicletype_edit','vehicletype_delete'])): ?>
							...
							<tbody>
							<?php $i=1;?>
							 <?php $__currentLoopData = $vehicaltypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicaltypess): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>
									<td><?php echo e($i); ?></td>
									<td><?php echo e($vehicaltypess -> vehicle_type); ?></td>
								...
								<!-- Custom Field Data End -->
									...
									<?php if(Gate::allows('vehicletype_edit') || Gate::allows('vehicletype_delete')): ?>
									<td>
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vehicletype_edit')): ?>
										<a href="<?php echo url ('/vehicletype/list/edit/'.$vehicaltypess->id); ?>"> <button type="button" class="btn btn-round btn-success"><?php echo e(trans('app.Edit')); ?></button></a>
										<?php endif; ?>
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vehicletype_delete')): ?>
										<a url="<?php echo url('/vehicletype/list/delete/'.$vehicaltypess->id); ?>" class="sa-warning"> <button type="button" class="btn btn-round btn-danger dgr"><?php echo e(trans('app.Delete')); ?></button></a>
										<?php endif; ?>
									</td>
									<?php endif; ?>
								</tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\garage\resources\views/vehicletype/list.blade.php ENDPATH**/ ?>