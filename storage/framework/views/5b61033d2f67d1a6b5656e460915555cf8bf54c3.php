					...
					<div class="x_content">
						<ul class="nav nav-tabs bar_tabs" role="tablist">
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_view')): ?>
								<li role="presentation" class="active"><a href="<?php echo url('/quotation/list'); ?>"><span class="visible-xs"></span> <i class="fa fa-list fa-lg">&nbsp;</i><b><?php echo e(trans('app.Quotation List')); ?></b></a></li>
							<?php endif; ?>
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_add')): ?>
								<li role="presentation" class=""><a href="<?php echo url('/quotation/add'); ?>"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i> <?php echo e(trans('app.Add Quotation')); ?> </a></li>
							<?php endif; ?>
						</ul>
					</div>
					<div class="x_panel table_up_div">
						<table id="datatable" class="table table-striped jambo_table" style="margin-top:20px;">
							<thead>
								<tr>
									<th>#</th>
									<th><?php echo e(trans('app.Quotation No')); ?></th>
									...
									<th><?php echo e(trans('app.Price')); ?> (<?php echo e(getCurrencySymbols()); ?>)</th>
									<!-- <th><?php echo e(trans('app.Customer Accepted Status')); ?></th> -->
							...
							<?php $i=1;?> 
								<?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $services): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td><?php echo e($i); ?></td>
										<td><?php echo e(getQuotationNumber($services->job_no)); ?></td>
										...
										<td><?php echo e(getTotalPriceOfQuotation($services->id)); ?></td>
										...
										<td>
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_view')): ?>
												...
												<button type="button" data-toggle="modal" data-target="#myModal" serviceid="<?php echo e($services->id); ?>" url="<?php echo url('/quotation/list/view'); ?>" class="btn btn-round btn-info save"><?php echo e(trans('app.View')); ?></button>
											<?php endif; ?>
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_edit')): ?>
												...
												<a href="<?php echo url('/quotation/list/edit/'.$services->id); ?>" ><button type="button" class="btn btn-round btn-success"><?php echo e(trans('app.Edit')); ?></button></a>

												<?php if($services->quotation_modify_status == 1): ?>
													<a href="<?php echo e(url('quotation/list/modify/'.$services->id)); ?>" ><button type="button" class="btn btn-round btn-success"><?php echo e(trans('app.Quotation Process')); ?></button></a>
												<?php elseif($services->quotation_modify_status == 2): ?>
													<a href="<?php echo e(url('quotation/list/modify/'.$services->id)); ?>" ><button type="button" class="btn btn-round btn-success" disabled><?php echo e(trans('app.Quotation Process')); ?></button></a>
												<?php endif; ?>									
											<?php endif; ?>
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_delete')): ?>
												<a url="<?php echo url('/quotation/list/delete/'.$services->id); ?>" class="sa-warning"><button type="button" class="btn btn-round btn-danger"><?php echo e(trans('app.Delete')); ?></button></a>
											<?php endif; ?>
										</td>
									</tr>
									<?php $i++; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\garage\resources\views//quotation/list.blade.php ENDPATH**/ ?>