				...
				<div class="nav_menu">
					<nav>
						<div class="nav toggle">
							<a id="menu_toggle"><i class="fa fa-bars"></i><span class="titleup">&nbsp <?php echo e(trans('app.Color')); ?></span></a>
						</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="checkbox checkbox-success checkbox-circle">
						  <?php if(session('message') == 'Successfully Submitted'): ?>
						   ...
						   <label for="checkbox-10 colo_success"> <?php echo e(trans('app.This color is used with a vehicle record. So you can not delete it.')); ?>  </label>
						   <?php endif; ?>
						...
						<div class="x_content">
							<ul class="nav nav-tabs bar_tabs" role="tablist">
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('colors_view')): ?>
									<li role="presentation" class="active"><a href="<?php echo url('/color/list'); ?>"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i><b><?php echo e(trans('app.Color List')); ?></b></a></li>
								<?php endif; ?>
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('colors_add')): ?>
									<li role="presentation" class=""><a href="<?php echo url('/color/add'); ?>"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i><?php echo e(trans('app.Add Color')); ?></a></li>
								<?php endif; ?>
							</ul>
						</div>
						<div class="x_panel ">
							<table id="datatable" class="table table-striped jambo_table" style="margin-top:20px;">
								<thead>
									<tr>
										<th>#</th>
										<th><?php echo e(trans('app.Color Name')); ?></th>
									...
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['colors_edit','colors_delete'])): ?>
								...
								<tbody>
									...
									<!-- Custom Field Data End -->
										...
										<?php if(Gate::allows('colors_edit') || Gate::allows('colors_delete')): ?>
										<td>
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('colors_edit')): ?>
												<a href="<?php echo url('/color/list/edit/'.$colors->id); ?>" ><button type="button" class="btn btn-round btn-success"><?php echo e(trans('app.Edit')); ?></button></a>
											<?php endif; ?>
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('colors_delete')): ?>
												<a url="<?php echo url('/color/list/delete/'.$colors->id); ?>" class="sa-warning"><button type="button" class="btn btn-round btn-danger dgr"><?php echo e(trans('app.Delete')); ?></button></a>
											<?php endif; ?>
										</td>
										<?php endif; ?>
									</tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\garage\resources\views/color/list.blade.php ENDPATH**/ ?>