					...
					<nav>
						<div class="nav toggle">
							<a id="menu_toggle">
								...
								<span class="titleup">&nbsp <?php echo e(trans('app.Support Staff')); ?></span>
							</a>
						</div>
		...
		<div class="x_content">
            <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
            	<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('supportstaff_view')): ?>
					<li role="presentation" class=""><a href="<?php echo url('/supportstaff/list'); ?>"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i> <?php echo e(trans('app.Supportstaff List')); ?></a></li>
				<?php endif; ?>
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('supportstaff_add')): ?>
					<li role="presentation" class="active setTabAddSupportStaffOnSmallDevice"><a href="<?php echo url('/supportstaff/add'); ?>"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i> <b><?php echo e(trans('app.Add Supportstaff')); ?></b></a></li>
				<?php endif; ?>
			</ul>
		</div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<div class="x_content">
						<form id="supportstaff_add_form" action="<?php echo url('/supportstaff/store'); ?>" method="post" 
						enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask supportSttafAddForm">
							...
							<div class="col-md-12 col-sm-6 col-xs-12">  
								<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group  has-feedback <?php echo e($errors->has('firstname') ? ' has-error' : ''); ?>">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										...
										value="<?php echo e(old('firstname')); ?>" placeholder="<?php echo e(trans('app.Enter First Name')); ?>" maxlength="50">
								...
								<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback <?php echo e($errors->has('lastname') ? ' has-error' : ''); ?>">
									<label class="control-label col-md-4 col-sm-4 col-xs-12" for="lastname"><?php echo e(trans('app.Last Name')); ?> <label class="color-danger">*</label>
									</label>
									<div class="col-md-8 col-sm-8 col-xs-12">
									  <input type="text" id="lastname" name="lastname" placeholder="<?php echo e(trans('app.Enter Last Name')); ?>" maxlength="50" value="<?php echo e(old('lastname')); ?>"
									  class="form-control">
							...
							<div class="col-md-12 col-sm-6 col-xs-12">  
								<div class="col-md-6 col-sm-6 col-xs-12 form-group <?php echo e($errors->has('dob') ? ' has-error' : ''); ?>">
									<label class="control-label col-md-4 col-sm-4 col-xs-12" for="dob"><?php echo e(trans('app.Date Of Birth')); ?></label>
								...
								<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
									<label class="control-label col-md-4 col-sm-4 col-xs-12" for="email"><?php echo e(trans('app.Email')); ?> <label class="color-danger">*</label>
									</label>
									<div class="col-md-8 col-sm-8 col-xs-12">
						...
						<!-- Custom field data -->
							...
							<div class="form-group col-md-12 col-sm-12 col-xs-12">
								<div class="col-md-12 col-sm-12 col-xs-12 text-center">
									...
									<button type="submit" class="btn btn-success supportSttafsubmitButton"><?php echo e(trans('app.Submit')); ?></button>
								</div>
							</div>
						</form>
					</div>
...
<?php echo JsValidator::formRequest('App\Http\Requests\SupportstaffAddEditFormRequest', '#supportstaff_add_form');; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\garage\resources\views/supportstaff/add.blade.php ENDPATH**/ ?>