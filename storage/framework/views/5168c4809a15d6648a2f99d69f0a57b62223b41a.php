...
<div class="right_col" role="main">
      ...
      <div class="nav_menu">
         <nav>
            <div class="nav toggle">
               <a id="menu_toggle"><i class="fa fa-bars"></i><span class="titleup">&nbsp <?php echo e(trans('app.Quotation')); ?></span></a>
            </div>
         ...
         <div class="x_content">
            <ul class="nav nav-tabs bar_tabs tabconatent customTabWidth" role="tablist">
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_view')): ?>
                  <li role="presentation" class=""><a href="<?php echo url('/quotation/list'); ?>"><span class="visible-xs" ></span><i class="fa fa-list fa-lg">&nbsp;</i><?php echo e(trans('app.Quotation List')); ?></span></a></li>
               <?php endif; ?>
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_edit')): ?>
                  <li role="presentation" class="active"><a href="<?php echo url('/quotation/list/modify/'.$services->id); ?>" class="process"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg i">&nbsp;</i><b><?php echo e(trans('app.Quotation Process')); ?></b></span></a></li>
               <?php endif; ?>
            </ul>
         </div>
      </div>
   ...
   <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_panel">
            <!-- <div class="well well-sm titleup">
               <?php echo e(trans('app.Processing Job for...'). getQuotationNumber($services->job_no)); ?>

            </div> -->
            <form method="post" action="<?php echo url('/quotation/add_modify_quotation'); ?>" class="addJobcardForm">
               <input type="hidden" class="service_id" name="service_id" value="<?php echo e($services->id); ?>"/>
               <hr/>
               <div class="col-md-12 col-xs-12 col-xs-12">
                  ...
                  <div class="col-md-5 col-xs-12 col-sm-12">
                     <div class="col-md-12 col-xs-12 col-sm-12">
                        <label class="control-label jobcardmargintop col-md-4 col-sm-12 col-xs-12"><?php echo e(trans('app.Quotation No')); ?> <label class="color-danger">*</label></label>
                        <div class="col-md-8 col-sm-12 col-xs-12">
                           <input type="text" id="job_no" name="job_no" value="<?php echo e(getQuotationNumber($services->job_no)); ?>" class="form-control" readonly>
                        </div>
                     </div>
                     ...
                     <!-- <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                        <label class="control-label jobcardmargintop col-md-4 col-sm-12 col-xs-12 "><?php echo e(trans('app.Out Date/Time')); ?> <label class="color-danger">*</label></label>
               ...
               <div class="col-md-12 col-xs-12 col-xs-12">
                  <div class="col-md-4 col-xs-12 col-sm-12">
                     ...
                     <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                           <input type="text" id="name" name="name" class="form-control" value="<?php echo e(getCustomerName($services->customer_id)); ?>" readonly>
                        </div>
                     </div>
                     <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                        <label class="control-label jobcardmargintop col-md-3 col-sm-3 col-xs-12"><?php echo e(trans('app.Address')); ?>:</label>
                        <div class="col-md-8 col-sm-12 col-xs-12">
                           <input type="text" id="address" name="address" class="form-control" value="<?php echo e(getCustomerAddress($services->customer_id)); ?>" readonly>
                        </div>
                     </div>
                     <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:8px;">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                           <input type="text" id="con_no" name="con_no" class="form-control" value="<?php echo e(getCustomerMobile($services->customer_id)); ?>" readonly>
                        </div>
                     </div>
                     <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:8px;">
                        <label class="control-label jobcardmargintop col-md-3 col-sm-3 col-xs-12"> <?php echo e(trans('app.Email')); ?>:</label>
                        <div class="col-md-8 col-sm-12 col-xs-12">
                           <input type="text" id="email" name="email" class="form-control" value="<?php echo e(getCustomerEmail($services->customer_id)); ?>" readonly>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-8 col-sm-12 col-xs-12 vehicle_space">
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" style="padding-top: 7px;"><?php echo e(trans('app.Model Name')); ?>:</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                           <input type="text" id="model" name="model" class="form-control" value="<?php echo e($vehicale->modelname); ?>" readonly>
                        </div>
                        <?php if(!empty($vehicale->chassisno)): ?>
                           <label class="jobcardmargintop col-md-2 col-sm-2 col-xs-12"><?php echo e(trans('app.Chasis No')); ?>: </label>
                           <div class="col-md-4 col-sm-4 col-xs-12">
                              <input type="text" id="chassisno" name="chassisno" class="form-control" value="<?php echo e($vehicale->chassisno); ?>" readonly>
                           </div>
                        <?php endif; ?>
                     </div>
                     <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                        <?php if(!empty($vehicale->chassisno)): ?>
                           ...
                           <div class="col-md-4 col-sm-4 col-xs-12">
                              <input type="text" id="engine_no" name="engine_no" class="form-control" value="<?php echo e($vehicale->engineno); ?>" readonly>
                           </div>
                        <?php endif; ?>
                        <!-- <label class="jobcardmargintop col-md-2 col-sm-2 col-xs-12"><?php echo e(trans('app.KMS Run')); ?>:
                ...
                <?php if(!empty($s_date)): ?>
                     <div class="col-md-12 col-sm-12 col-xs-12 divId" id="divId" style="margin-top:5px;" >
                        <label class="control-label col-md-2 col-sm-2 col-xs-12"><?php echo e(trans('app.Date Of Sale')); ?>: </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                           <input type="text" id="sales_date" name="sales_date" class="form-control" value="<?php echo e(date(getDateFormat(), strtotime($s_date->date))); ?>" readonly>
                        </div>
                        <!-- <label class="jobcardmargintop col-md-2 col-sm-2 col-xs-12"><?php echo e(trans('app.Color')); ?>:</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                           <input type="text" id="color" name="color" class="form-control" value="<?php if(!empty($color)): ?> <?php echo e($color->color); ?> <?php endif; ?>" readonly >
                        </div> -->
                     </div>
                <?php endif; ?>
                     <?php if(!empty($job->coupan_no)): ?>
                     <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                        <label class="col-md-2 col-sm-2 col-xs-12"><?php echo e(trans('app.Free Service Coupan No')); ?>:</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="panel panel-default">
                     <div class="panel-heading">
                        <h4 class="panel-title tbl_points">
                           <a data-toggle="collapse" href="#collapse1" class="observation_Plus" style="color:#5A738E"><i class="plus-minus glyphicon glyphicon-minus "></i>  <?php echo e(trans('app.Observation Points')); ?></a>
                        </h4>
                     </div>
                     ...
                     <table class="table table-bordered  adddatatable main_data_points" id="main_data_points" align="center">
                        <thead>
                           <tr>
                              ...
                              <th><?php echo e(trans('app.Observation Point')); ?></th>
                              <th><?php echo e(trans('app.Select Product')); ?></th>
                              <th style="width:9%;"><?php echo e(trans('app.Price')); ?> (<?php echo getCurrencySymbols(); ?>)</th>
                              <th style="width:10%;"><?php echo e(trans('app.Quantity')); ?></th>
                              <th style="width:10%;"><?php echo e(trans('app.Total Price')); ?> (<?php echo getCurrencySymbols(); ?>)</th>
                              <th style="width:10%;"><?php echo e(trans('app.Chargeable')); ?></th>
                              <th><?php echo e(trans('app.Comments')); ?></th>
                        ...
                        <tbody id="tbd">
                           ...
                           <tr class="obs_point_data" id="<?php echo "row_id_delete_".$i; ?>">
                              ...
                              <td>
                                 <select name="product2[product_id][]" class="form-control product_ids product1s_<?php echo e($i); ?>"  url="<?php echo e(url('/jobcard/getprice')); ?>" row_did="<?php echo e($i); ?>" id="product1s_<?php echo e($i); ?>" qtyappend="" required >
                              ...
                              <td>
                                 ...
                                 <input type="text" name="product2[price][]" value="<?php if(!empty($data)){ echo $datas->price; } ?>" value="<?php echo $products->price; ?>" class="form-control prices rate product1_<?php echo $i; ?> product1_<?php echo $i; ?> price_<?php echo $i; ?>" id="product1_<?php echo $i; ?>" row_id="<?php echo e($i); ?>" maxlength="8" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                 <?php endif; ?>      
                              </td>
                              ...
                              <td>
                                 <?php echo e(trans('app.Yes:')); ?> <input type="radio" name="yesno_[]<?php echo $i;?>" class="yes_no" value="1" <?php if($datas->chargeable == 1) { echo "checked"; } ?> style=" height:13px; width:20px; margin-right:5px;" >
                                    
                                 <?php echo e(trans('app.No:')); ?> <input type="radio" name="yesno_[]<?php echo $i;?>" class="yes_no" value="0" <?php if($datas->chargeable == 0) { echo "checked"; } ?> style="height:13px; width:20px;">
                              </td>
                              <td><textarea name="product2[comment][]" class="form-control" maxlength="250"><?php echo e($datas->category_comments); ?></textarea> </td>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 panel-group">
               <div class="col-md-10 col-sm-8 col-xs-8">
                  <h2><?php echo e(trans('app.Other Service Charges')); ?></h2>
               </div>
               <div class="col-md-2 col-sm-4 col-xs-4">
                  <button type="button" id="add_new_product" class="btn btn-default" url="<?php echo url('/jobcard/addproducts'); ?>" style="margin:5px 0px;"><?php echo e(trans('app.Add New')); ?> </button>
               </div>
            </div>
            <div class="col-md-12 col-xs-12 col-sm-12">
               <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:20px;">
                 <table class="table table-bordered addtaxtype" id="tab_products_detail" align="center">
                   <thead>
                     <tr>
                        <th class="all"><?php echo e(trans('app.Product')); ?></th>
                        <th class="all"><?php echo e(trans('app.Price')); ?> (<?php echo getCurrencySymbols(); ?>)</th>
                        <th>Action</th>
                     </tr>
                   </thead>
                   <tbody>
                     <?php if(!empty($pros)): ?>
                     <?php $id = 1; ?>
                     <?php $__currentLoopData = $pros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <!-- Checking for MOT Test status -->
         <?php if($fetch_mot_test_status->mot_status == 1): ?>
            <div class="col-md-12 col-sm-12 col-xm-12 panel-group">
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h4 class="panel-title"><?php echo e(trans('app.MOT Test Service Charge')); ?></h4>
                  </div>
               </div>
            </div>
         <?php endif; ?>
      <!-- End MOT Test Checking -->
            ...
            <!-- model in observation Point -->
                     ...
                     <div class="modal-dialog">
                        <div class="modal-content">
                                          ...
                                          <table class="table table-striped">
                                             <thead>
                                                <tr>
                                                   ...
                                                   <td>
                                                      <b><?php echo e(trans('app.Checkpoints')); ?></b>
                                                   </td>
                                                   <td>
                                                      <b><?php echo e(trans('app.Choose')); ?></b>
                                                   </td>
                                                </tr>
                                             </thead>
                                             <tbody>
                                                ...
                                                <tr class="id<?php echo e($subcategorys->checkout_point); ?>">
                                                   ...
                                                   <td>
                                                      <input type="checkbox" <?php echo $data;?> name="chek_sub_points" name="check_sub_points[]" check_id="<?php echo e($subcategorys->id); ?>" class="check_pt" url="<?php echo url('jobcard/select_checkpt'); ?>"  s_id = "<?php echo e(getServiceId($services->id)); ?>" sale_id = "<?php echo e($services->id); ?>" sub_pt="<?php echo e($subcategorys->checkout_point); ?>" main_cat="<?php echo e($checkoout->checkout_point); ?>">
                                                   </td>
                                                </tr>
                                                <?php }
                                                   } ?>
                           ...
                           <div class="modal-footer">
                              <button type="button" class="btn btn-success col-md-offset-10 check_submit observationPointModelSubmitButton" style="margin-bottom:5px;" disabled="true" ><?php echo e(trans('app.Submit')); ?></button>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px; margin-bottom:15px;">
                  <div class="col-md-8 col-sm-12 col-xs-12">
                     ...
                     <input type="checkbox" id="finalSubmit" name="finalSubmit" class="" style="height:20px; width:20px; margin-right:5px; position: relative; top: 6px; margin-bottom: 12px;">
                       <span for="finalSubmit" class="text-danger"><?php echo e(trans('app.Quotaion is final, then click here.')); ?></span>
                     </label>
                  </div>
               </div>
               ...
               <div class="form-group col-md-12 col-sm-12 col-xs-12">
                  ...
                  <button type="submit" class="btn btn-success addJobcardSubmitButton"><?php echo e(trans('app.Submit')); ?></button>
                  </div>
               </div>
            </form>
         </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\garage\resources\views/quotation/quotationmodify.blade.php ENDPATH**/ ?>