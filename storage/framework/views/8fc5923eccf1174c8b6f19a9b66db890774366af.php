<tr id="row_id_<?php echo $ids;?>">
	...
	<td class="tbl_td_selectManufac_error_<?php echo $ids;?>">
		...
		<select class="form-control select_producttype select_producttype_<?php echo $ids;?>" name="product[Manufacturer_id][]" m_url="<?php echo url('/purchase/producttype/names'); ?>" row_did="<?php echo $ids;?>" data-id="1" style="width:100%;" required="true">
	...
	<td class="tbl_td_quantity_error_<?php echo $ids;?>">
		<input type="text" name="product[qty][]"  row_id="<?php echo $ids; ?>" class="quantity form-control qty qty_<?php echo $ids;?> qtyt" id="qty_<?php echo $ids;?>" autocomplete="off"  value="" prd_url="<?php echo e(url('/sale_part/get_available_product')); ?>" style="width: 50%;" maxlength="8" required="true">
...
</script><?php /**PATH C:\xampp\htdocs\garage\resources\views/sales_part/newproduct.blade.php ENDPATH**/ ?>