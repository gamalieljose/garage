				...
				<div class="x_content">
					<ul class="nav nav-tabs bar_tabs" role="tablist">
						<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee_view')): ?>
							<li role="presentation" class="active"><a href="<?php echo url('/employee/list'); ?>"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i><b><?php echo e(trans('app.Employee List')); ?></b></a></li>
						<?php endif; ?>
						
						<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee_add')): ?>
							<li role="presentation" class=""><a href="<?php echo url('/employee/add'); ?>"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i> <?php echo e(trans('app.Add Employee')); ?></a></li>
						<?php endif; ?>
					</ul>
				</div>
				<div class="x_panel">
					<table id="datatable" class="table table-striped  jambo_table" style="margin-top:20px;" >
						<thead>
							...
							<tr>
								...
								<?php if(getUserRoleFromUserTable(Auth::User()->id) == 'Customer'): ?>
									<?php if(Gate::allows('employee_add') || Gate::allows('employee_edit') || Gate::allows('employee_delete')): ?>
										<th><?php echo e(trans('app.Action')); ?></th>
									<?php endif; ?>
								<?php endif; ?>
							</tr>
						...
						<?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><?php echo e($i); ?></td>
								<td><img src="<?php echo e(URL::asset('public/employee/'.$users->image)); ?>"  width="50px" height="50px" class="img-circle"></td>
								<td><?php echo e($users->name); ?></td>
								<td><?php echo e($users->lastname); ?></td>
								<td><?php echo e($users->email); ?></td>
								<td><?php echo e($users->mobile_no); ?></td>
								...
								<td>
									<?php if(getUserRoleFromUserTable(Auth::User()->id) == 'admin' || 	getUserRoleFromUserTable(Auth::User()->id) == 'supportstaff' || getUserRoleFromUserTable(Auth::User()->id) == 'accountant' || getUserRoleFromUserTable(Auth::User()->id) == 'employee'): ?>
										...
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee_view')): ?>
											<a href="<?php echo url('/employee/view/'.$users->id); ?>"><button type="button" class="btn btn-round btn-info"><?php echo e(trans('app.View')); ?></button></a>
										<?php endif; ?>
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee_edit')): ?>
											<a href="<?php echo url('/employee/edit/'.$users->id); ?>" ><button type="button" class="btn btn-round btn-success"><?php echo e(trans('app.Edit')); ?></button></a>
										<?php endif; ?>
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee_delete')): ?>
											<a url="<?php echo url('/employee/list/delete/'.$users->id); ?>" class="sa-warning"><button type="button" class="btn btn-round btn-danger"><?php echo e(trans('app.Delete')); ?></button></a>
										<?php endif; ?>
									<?php endif; ?>

									<?php if(Auth::User()->id == $users->id): ?>
										<?php if(!Gate::allows('employee_edit')): ?>
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee_owndata')): ?>
											<a href="<?php echo url('/employee/edit/'.$users->id); ?>" ><button type="button" class="btn btn-round btn-success"><?php echo e(trans('app.Edit')); ?></button></a>
											<?php endif; ?>
										<?php endif; ?>
									<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\garage\resources\views/employee/list.blade.php ENDPATH**/ ?>