...
<div class="lgn_padding">
      ...
      <div class="login_wrapper">
        ...
        <div class="animate form login_form">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo e(url('/login')); ?>">
              ...
              <div class="loginpading <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
              ...
              <div class="loginpading <?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
              ...
              <div class="separator">
				...
				<p class="change_link ">
                  <a href="<?php echo e(url('/password/reset')); ?>" class="to_register logintextcolor"> Forgot Password </a>
                </p>
	...
	<?php if(!empty(session('firsttime'))): ?>
	...
	<?php endif; ?>
                      ...
                      <?php /**PATH C:\xampp\htdocs\garage\resources\views/auth/login.blade.php ENDPATH**/ ?>