		...
		<div class="x_content">
			<ul class="nav nav-tabs bar_tabs" role="tablist">
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_view')): ?>
					<li role="presentation" class=""><a href="<?php echo url('/quotation/list'); ?>"><span class="visible-xs"></span> <i class="fa fa-list fa-lg">&nbsp;</i><?php echo e(trans('app.Quotation List')); ?></a></li>
				<?php endif; ?>
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quotation_add')): ?>
					<li role="presentation" class="active"><a href="<?php echo url('/quotation/add'); ?>"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i><b><?php echo e(trans('app.Add Quotation')); ?></b></a></li>
				<?php endif; ?>
			</ul>
		</div>
				...
				<div class="x_panel">
					<div class="x_content">
						<div class="panel panel-default">
							<!-- <div class="panel-heading step titleup"><?php echo e(trans('app.Step - 1 : Add Service Details...')); ?></div> -->
								<form id="QuotationAdd-Form" method="post" action="<?php echo e(url('/quotation/store')); ?>" enctype="multipart/form-data"  class="form-horizontal upperform serviceAddForm" border="10">
				   
									<div class="form-group">
										<div class="my-form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name"><?php echo e(trans('app.Quotation Number')); ?> <label class="color-danger">*</label></label>
									...
									<div class="form-group" style="margin-top: 15px;">
										<!-- <div class="">
											<label class="control-label col-md-2 col-sm-2 col-xs-12" for="number_plate"><?php echo e(trans('app.Number Plate')); ?></label>
											<div class="col-md-4 col-sm-4 col-xs-12">
												<input type="text" name="number_plate" id="number_plate" placeholder="<?php echo e(trans('app.Enter Number Plate')); ?>"  value="<?php echo e(old('number_plate')); ?>" maxlength="15" class="form-control" >
											</div>
										</div> -->
									...
									<!-- Tax field start -->									
										<div class="">
											<label class="control-label col-md-2 col-sm-2 col-xs-12" for="cus_name"><?php echo e(trans('app.Tax')); ?></label>
											<div class="col-md-4 col-sm-4 col-xs-12">
												<table>
													<tbody>
													<?php $__currentLoopData = $tax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<tr>
															<td>
																...
																echo $taxes->id;?>" taxrate="<?php echo e($taxes->tax); ?>" taxName="<?php echo e($taxes->taxname); ?>" style="height:20px; width:20px; margin-right:5px; position: relative; top: 6px; margin-bottom: 12px;" >
																<?php 
							...
							<!-- Start Custom Field, (If register in Custom Field Module)  -->
									<?php if(!empty($tbl_custom_fields)): ?>
										<div class="col-md-12 col-sm-12 col-xs-12 space">
											<h4><b><?php echo e(trans('app.Custom Field')); ?></b></h4>
										...
										<?php $__currentLoopData = $tbl_custom_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tbl_custom_field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											...
											<div class="form-group col-md-6 col-sm-6 col-xs-12">
												<label class="control-label col-md-4 col-sm-4 col-xs-12" for="account-no"><?php echo e($tbl_custom_field->label); ?> <label class="text-danger"><?php echo e($red); ?></label>
												</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													...
													<?php else: ?>
														<input type="<?php echo e($tbl_custom_field->type); ?>"  name="custom[<?php echo e($tbl_custom_field->id); ?>]"  class="form-control" placeholder="<?php echo e(trans('app.Enter')); ?> <?php echo e($tbl_custom_field->label); ?>" maxlength="25" <?php echo e($required); ?>>
													<?php endif; ?>
												</div>
											</div>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
...
<?php echo JsValidator::formRequest('App\Http\Requests\StoreQuotationAddEditFormRequest', '#QuotationAdd-Form');; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\garage\resources\views/quotation/add.blade.php ENDPATH**/ ?>