<tr id="row_id_<?php echo $ids;?>">
	...
	<td>
		<select class="form-control select_producttype" name="product[Manufacturer_id][]" m_url="<?php echo url('/purchase/producttype/name'); ?>" man_sel_url="<?php echo url('purchase/getfirstproductdata'); ?>" row_did="<?php echo $ids;?>" data-id="<?php echo $ids;?>" row_id="<?php echo $ids;?>" style="width:100%;" required>
	...
	<td>
		...
		<span class="qty_<?php echo $ids;?>"><?php echo e($first_product->product_no); ?></span>
	</td>
	<td>
		...
		<input type="text" name="product[price][]" class="product form-control prices price_<?php echo $ids;?>"  value="<?php echo e($first_product->price); ?>" id="price_<?php echo $ids;?>" row_id="<?php echo $ids;?>" style="width:100%;" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
	</td>
	<td>
		<input type="text" name="product[total_price][]" class="product form-control total_price total_price_<?php echo $ids;?>"  value="<?php echo e($first_product->price); ?>" style="width:100%;"  id="total_price_<?php echo $ids;?>" readonly="true">
	</td>
...
</script><?php /**PATH C:\laragon\www\garage\resources\views/purchase/newproduct.blade.php ENDPATH**/ ?>