...
<script>
	...
	<div class="modal-header" >
          ...
          <h4 class="modal-title"><?php echo e(trans('app.Service Details for Jobcard Number')); ?> - <?php echo $vhi_no->job_no; ?></h4>
    </div>
		...
		<div class="row">
			<div class="col-md-7 col-sm-7 col-xs-12">
				...
				<div class="col-md-6 col-sm-12 col-xs-12 printimg">
					<img src="<?php echo e(URL::asset('public/general_setting/'.$logo->logo_image)); ?>" width="200px" height="70px">
				</div>
			...
			<div class="col-md-5 col-sm-5 col-xs-12">
				<table class="table">
				  <tbody>
					...
					<tr>
					  <th><?php echo e(trans('app.Contact:')); ?></th>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">	
					<table class="table table-bordered adddatatable" width="100%">
						<thead>
						<tr>
							<th class="cname text-center"><?php echo e(trans('app.Jobcard Number')); ?></th>
							<th class="cname text-center"><?php echo e(trans('app.Coupon Number')); ?></th>
							<th class="cname text-center"><?php echo e(trans('app.Vehicle Name')); ?></th>
							<th class="cname text-center"><?php echo e(trans('app.Number Plate')); ?></th>
							<th class="cname text-center"><?php echo e(trans('app.In Date')); ?></th>
							<th class="cname text-center"><?php echo e(trans('app.Out Date')); ?></th>								
						</tr>
						</thead>
						<tbody>
						<?php if(!empty($used_cpn_data)): ?>
						<tr>
					...
					<table class="table table-bordered adddatatable" width="100%">
						<thead>
							<tr>
								<th class="cname text-center"><?php echo e(trans('app.Assigned To')); ?></th>
								<th class="cname text-center"><?php echo e(trans('app.Repair Category')); ?></th>
								<th class="cname text-center"><?php echo e(trans('app.Service Type')); ?></th>
								<th class="cname text-center"><?php echo e(trans('app.Details')); ?></th>
							</tr>	
						</thead>
						<tbody>
							<tr>
					...
					<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
						<tbody>
							<tr class="printimg">
								<td class="cname"><?php echo e(trans('app.SERVICE CHARGES')); ?></td>
							</tr>
						</tbody>
					</table>
					<table class="table table-bordered adddatatable" width="100%" border="1" style="border-collapse:collapse;">
						<thead>				
							<tr>
								...
								<th class="text-center"><?php echo e(trans('app.Observation Point')); ?></th>
								<th class="text-center"><?php echo e(trans('app.Product Name')); ?></th>
								<th class="text-center"><?php echo e(trans('app.Price')); ?> (<?php echo getCurrencySymbols(); ?>)</th>
								<th class="text-center"><?php echo e(trans('app.Quantity')); ?> </th>
								<th class="text-center"><?php echo e(trans('app.Total Price')); ?> (<?php echo getCurrencySymbols(); ?>) </th>
							</tr>
						</thead>
						<tbody>
							<?php 
					...
					<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
							<tr class="printimg">
								<td class="cname" colspan="7"><?php echo e(trans('app.OTHER SERVICE CHARGES')); ?></td>
							</tr>
					</table>
					<table class="table table-bordered adddatatable" width="100%" border="1" style="border-collapse:collapse;">
						<thead>	
							<tr>
								<th class="text-center">#</th>
								<th class="text-center"><?php echo e(trans('app.Charge for')); ?></th>
								<th class="text-center"><?php echo e(trans('app.Product Name')); ?></th>
								<th class="text-center"><?php echo e(trans('app.Price')); ?> (<?php echo getCurrencySymbols(); ?>)</th>
								<th class="text-center"><?php echo e(trans('app.Total Price')); ?> (<?php echo getCurrencySymbols(); ?>) </th>
							</tr>
						...
						<tbody>
							...
							if(!empty($all_data2))
							{
								...
								<tr>
									<td class="text-center cname"><?php echo $i++; ?></td>
									<td class="text-center cname"><?php echo e(trans('app.Other Charges')); ?></td>
			...
			<!-- MOT Test Service Charge Details Start -->
				<?php  
               	...
               	?>
					...
					<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
							<tr class="printimg">
								<td class="cname"><?php echo e(trans('app.MOT TEST SERVICE CHARGE')); ?></td>
							</tr>
					</table>
					...
					<table class="table table-bordered adddatatable" width="100%" border="1" style="border-collapse:collapse;">
						<thead>	
							<tr>
								<th class="text-center">#</th>
								<th class="text-center"><?php echo e(trans('app.MOT Charge Detail')); ?></th>
								<th class="text-center"><?php echo e(trans('app.MOT Test')); ?></th>
								<th class="text-center"><?php echo e(trans('app.Price')); ?> (<?php echo getCurrencySymbols(); ?>)</th>
								<th class="text-center"><?php echo e(trans('app.Total Price')); ?> (<?php echo getCurrencySymbols(); ?>)</th>
							</tr>
						</thead>
						<tbody>
                        	<tr>
                           		...
                           		<td class="text-center cname"><?php echo e(trans('app.MOT Testing Charges')); ?></td>
                           		<td class="text-center cname"><?php echo e(trans('app.Completed')); ?></td>
			...
			<!-- For Custom Field -->
				<?php if(!empty($tbl_custom_fields)): ?>
					<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
							<tr class="printimg">
								<td class="cname" colspan=""><?php echo e(trans('app.OTHER INFORMATION')); ?></td>
							</tr>
					</table>
						...
						<?php $__currentLoopData = $tbl_custom_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tbl_custom_field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>	
							...
							<?php if($tbl_custom_field->type == "radio"): ?>
								<?php if($datavalue != ""): ?>
									...
									<tr>
										<th class="text-center"><?php echo e($tbl_custom_field->label); ?> :</th>
										<td class="text-center cname"><?php echo e($radio_selected_value); ?></td>
									</tr>
								<?php else: ?>
									<tr>
										<th class="text-center"><?php echo e($tbl_custom_field->label); ?> :</th>
										<td class="text-center cname"><?php echo e(trans('app.Data not available')); ?></td>
									</tr>
								<?php endif; ?>
							<?php else: ?>
								<?php if($datavalue != null): ?>
									<tr>
										<th class="text-center"><?php echo e($tbl_custom_field->label); ?> :</th>
										<td class="text-center cname"><?php echo e($datavalue); ?></td>
									</tr>
								<?php else: ?>
									<tr>
										<th class="text-center"><?php echo e($tbl_custom_field->label); ?> :</th>
    ...
    </div><?php /**PATH C:\xampp\htdocs\garage\resources\views/service/servicemodel.blade.php ENDPATH**/ ?>